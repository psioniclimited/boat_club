                   <div class="col-md-6">  
                     <div class="form-group @if ($errors->has('offer_date')) has-error @endif">  
                      ...
                      <input type="text" class="form-control" id="offer_date" name="offer_date" placeholder="Offer Date" value="{{old('offer_date')}}" data-date-format='yyyy-mm-dd'> 
                  ...
                  <div class="col-md-6">  
                   <div class="form-group @if ($errors->has('confirmation_date')) has-error @endif">  
                    ...
                    <input type="text" class="form-control" id="confirmation_date" name="confirmation_date" placeholder="Confirmation Date" value="{{old('confirmation_date')}}" data-date-format='yyyy-mm-dd'> 
                ...
                <div class="col-md-6">  
                  <div class="form-group @if ($errors->has('date_of_joining')) has-error @endif">  
                    ...
                    <input type="text" class="form-control" id="date_of_joining" name="date_of_joining" placeholder="Joining Date" value="{{old('date_of_joining')}}" data-date-format='yyyy-mm-dd'> 
                ...
                <div class="col-md-6">  
                  <div class="form-group @if ($errors->has('retirement_date')) has-error @endif">  
                    ...
                    <input type="text" class="form-control" id="retirement_date" name="retirement_date" placeholder="Retirement Date" value="{{old('retirement_date')}}" data-date-format='yyyy-mm-dd'> 
                ...
                <div class="col-md-6">  
                  <div class="form-group @if ($errors->has('contract_end_date')) has-error @endif">  
                    ...
                    <input type="text" class="form-control" id="contract_end_date" name="contract_end_date" placeholder="Contract End Date" value="{{old('contract_end_date')}}" data-date-format='yyyy-mm-dd'> 
                ...
                <div class="col-md-6">  
                  <div class="form-group @if ($errors->has('company_email')) has-error @endif">  
                    ...
                    <input type="text" class="form-control" id="company_email" name="company_email" placeholder="Company Email" value="{{old('company_email')}}" > 
                ...
                <div class="col-md-6">  
                  <div class="form-group @if ($errors->has('notice_day')) has-error @endif">  
                    ...
                    <input type="text" class="form-control" id="notice_day" name="notice_day" placeholder="Notice Day" value="{{old('notice_day')}}" > 
