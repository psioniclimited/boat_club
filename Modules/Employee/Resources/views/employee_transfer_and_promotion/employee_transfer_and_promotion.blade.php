  ...
  <div class="row">
    ...
    <div class="col-md-12"> 
      <div class="box box-info">
        ...
        {!! Form::open(array('route'=>'employee_transfer_and_promotion.store','id'=>'employee_transfer_form','class' => 'form-horizontal')) !!}
        <div class="box-body">
          <div class="col-md-6">  

            <div class="form-group @if ($errors->has('action_type')) has-error @endif">
              ...
              @if ($errors->has('action_type')) <p class="help-block">{{ $errors->first('action_type') }}</p> @endif                             
            </div>  
...
<script>
  ...
  $(document).ready(function () {
    ...
    $('#employee_transfer_form').validate({
      ...
      messages: {  
        action_type: {required: "Please give Action"},
