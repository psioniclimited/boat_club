        ...
        <div class="box-body">
          ...
          <div class="col-md-6">  
            <div class="form-group @if ($errors->has('applicant_name')) has-error @endif">
              ...
              <input type="text" class="form-control" id="applicant_name" name="applicant_name" placeholder="Enter Applicant Name" value="{{$job_applicant->applicant_name}}" > 
            ...
            <div class="form-group @if ($errors->has('applicant_email')) has-error @endif">
              ...
              <input type="text" class="form-control" id="applicant_email" name="applicant_email" placeholder="Enter Email Address" value="{{$job_applicant->applicant_email}}" > 
            ...
            <div class="form-group @if ($errors->has('applicant_contact')) has-error @endif">
              ...
              <input type="text" class="form-control" id="applicant_contact" name="applicant_contact" placeholder="Enter Contact Number" value="{{$job_applicant->applicant_contact}}" > 
          ...
          <div class="col-md-6">  
            ...
            <div class="form-group @if ($errors->has('job_applicant_status_id')) has-error @endif">
              ...
              <select name="job_applicant_status_id" id="job_applicant_status_id" class="form-control"> 
                ...
                @if($status->id==$job_applicant->job_applicant_status_id)
          ...
          <div class="box-header">
            ...
            <div class="pull-right box-tools">
              ...
              <div class="box-body pad"> 
                <textarea name="cover_letter" class="textarea" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">
                  {{$job_applicant->cover_letter}}
                </textarea>
              </div>
            </div> 
            <div class="box">
              <div class="box-header">
                ...
                <div class="pull-right box-tools">
                  ...
                  <!-- /.box-header -->
                  <div class="box-body pad"> 
                    <input type="file" name="resume" value="{{asset('/uploads/resume'.'/'.$job_applicant->resume)}}">
                  </div>
                </div> 
