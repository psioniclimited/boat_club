...
<link rel="stylesheet" href="{{asset('bower_components/AdminLTE')}}/plugins/datatables/dataTables.bootstrap.css">  <style>
    .col-md-6{
        padding-right: 20px;
    }
</style>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-info">
                ...
                {!! Form::open(array('route'=>'district.store','id'=>'add_district_form','class' => 'form-horizontal')) !!}
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-6 bootstrap-timepicker"> 
                        <div class="form-group @if ($errors->has('punch_in')) has-error @endif">
                            <label for="name" class="control-label">Punch In Time*</label> 
                            <input type="text" class="form-control" id="punch_in" name="punch_in" placeholder="Enter Time" value="{{old('punch_in')}}"> 
                            @if ($errors->has('punch_in')) <p class="help-block">{{ $errors->first('punch_in') }}</p> @endif                             
                        </div>
                    </div>
...
<script>
    ...
    $('#add_district_form').validate({
        ...
        rules: {
            district_name: {required: true, minlength: 4}
        },
        messages: {
            district_name: {required: "Please give name"}
        }
    });
    ...
    var table = $('#all_role_table').DataTable({
       ...
       "processing": true,
       "serverSide": true,
       "ajax": "{{URL::to('/district/get_all_districts')}}",
       "columns": [ 
       {"data": "district_name"}, 
