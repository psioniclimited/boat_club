...
class AttendanceDeductionController extends Controller
{
    /**
    ...
    {
        return view('organization::attendance_deduction.list_of_deduction_policies');
    }
    ...
    {
        return view('organization::attendance_deduction.create_attendance_deduction');
    }
