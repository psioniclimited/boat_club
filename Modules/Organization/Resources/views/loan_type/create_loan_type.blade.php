...
<section class="content">
  <div class="row"> 
    ...
    <div class="box box-info">
      ...
      {!! Form::open(array('route'=>'loan_type.store','id'=>'add_loan_type','class' => 'form-horizontal')) !!}
      ...
      <div class="box-body">
        ...
        <div class="col-md-12"> 
          <div class="form-group @if ($errors->has('loan_type_name')) has-error @endif">
            ...
            <input type="text" class="form-control" id="loan_type_name" name="loan_type_name" placeholder="Enter name" value="{{old('loan_type_name')}}"> 
        ...
        <div class="col-md-12"> 
          <div class="form-group @if ($errors->has('annual_interest_rate')) has-error @endif">
            ...
            <input type="number" class="form-control" id="annual_interest_rate" name="annual_interest_rate" placeholder="Enter Amount" value="{{old('annual_interest_rate')}}" min="0"> 
