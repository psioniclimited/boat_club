    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="box box-info">
                ...
                {!! Form::open(array('route'=>'designation.store','id'=>'add_designation_form','class' => 'form-horizontal')) !!}
                <div class="box-body">
                    <div class="col-md-12"> 
                        <div class="form-group @if ($errors->has('designation_name')) has-error @endif">
                            ...
                            <input type="text" class="form-control" id="designation_name" name="designation_name" placeholder="Enter name" value="{{old('designation_name')}}"> 
