    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="box box-info">
                ...
                {!! Form::open(array('route' => array('designation.update', $designation->id), 'id' => 'add_designation_form', 'method'=>'PUT')) !!}                
                <div class="box-body">
                    <div class="col-md-12"> 
                        <div class="form-group @if ($errors->has('designation_name')) has-error @endif">
                            ...
                            <input type="text" class="form-control" id="designation_name" name="designation_name" placeholder="Enter name" value="{{$designation->designation_name}}"> 
...
<script>
    ...
    $('#add_designation_form').validate({
        ...
        rules: {
            designation_name: {required: true, minlength: 4}
        },
        messages: {
            designation_name: {required: "Please give name"}
        }
    });
    ...
    var table = $('#all_role_table').DataTable({
     ...
     "processing": true,
     "serverSide": true,
     "ajax": "{{URL::to('/designation/get_all_designations')}}",
     "columns": [ 
