                ...
                <div class="box-body">
                        ...
                        <div class="bootstrap-timepicker">
                            <div class="form-group @if ($errors->has('start_from')) has-error @endif">
                              ...
                              <div class="input-group"> 
                                <input type="text" class="form-control pull-right" id="start_from" name="start_from" placeholder="Select Start Time" value="{{old('start_from')}}">
                    ...
                    <div class="bootstrap-timepicker">
                        <div class="form-group @if ($errors->has('end_to')) has-error @endif">
                          ...
                          <div class="input-group"> 
                            <input type="text" class="form-control pull-right" id="end_to" name="end_to" placeholder="Select Finish Time" value="{{old('end_to')}}">
                            <div class="input-group-addon">
                                <i class="fa fa-clock-o"></i>
                            </div>
