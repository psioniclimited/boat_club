        ...
        <div class="box-body">
          <div class="col-md-12"> 
            ...
            <div class="form-group @if ($errors->has('holiday_list_name')) has-error @endif">
              ...
              <input type="text" class="form-control" id="holiday_list_name" name="holiday_list_name" placeholder="Enter name" value="{{old('holiday_list_name')}}" > 
...
<script>
  ...
  $(document).ready(function () {
    ...
    var table = $('#all_role_table').DataTable({
     ...
     "processing": true,
     "serverSide": true,
     "ajax": "{{URL::to('/holiday/get_all_holiday_lists')}}",
     "columns": [ 
     {"data": "holiday_list_name"},    
