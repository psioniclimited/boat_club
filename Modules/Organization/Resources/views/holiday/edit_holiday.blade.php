  ...
  <div class="row">
    ...
    <div class="col-md-12"> 
      <div class="box box-info">
        ...
        {!! Form::open(array('route' => array('holiday.update', $holiday->id), 'id' => 'add_holiday_form', 'method'=>'PUT')) !!}    
        <div class="box-body">
          <div class="col-md-12"> 

            <div class="form-group @if ($errors->has('description')) has-error @endif">
              <label for="name" class="control-label">Holiday Name*</label> 
              <input type="text" class="form-control" id="description" name="description" placeholder="Enter name" value="{{$holiday->description}}" > 
            ...
            <div class="form-group @if ($errors->has('holiday_date')) has-error @endif">
              ...
              <input type="text" class="form-control" id="holiday_date" name="holiday_date" placeholder="Enter Date" value="{{$holiday->holiday_date}}"  data-date-format='yyyy-mm-dd' > 
