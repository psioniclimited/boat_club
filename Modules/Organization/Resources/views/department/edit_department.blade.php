    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="box box-info">
                ...
                {!! Form::open(array('route' => array('department.update', $department->id), 'id' => 'add_department_form', 'method'=>'PUT')) !!}                  
                ...
                <div class="box-body">
                    <div class="col-md-12"> 
                        <div class="form-group @if ($errors->has('department_name')) has-error @endif">
                            ...
                            <input type="text" class="form-control" id="department_name" name="department_name" placeholder="Enter name" value="{{$department->department_name}}"> 
                            @if ($errors->has('department_name')) <p class="help-block">{{ $errors->first('department_name') }}</p> @endif                             
                        </div>
                        <div class="form-group @if ($errors->has('address')) has-error @endif">
                            <label for="name" class="control-label">Address*</label> 
                            <input type="text" class="form-control" id="address" name="address" placeholder="Enter Address" value="{{$department->address}}"> 
...
$.get( "{{URL::to('/department/auto/get_department/department_type')}}", { department_id: $('#department_id').val() } ,function( data ) {
...
// initialize select2 for department_type_id
$.get( "{{URL::to('/department/auto/get_department/branch')}}", { department_id: $('#department_id').val() } ,function( data ) {
    init_select2_with_default_value({
        default_value: data,
        placeholder: "Branch",
