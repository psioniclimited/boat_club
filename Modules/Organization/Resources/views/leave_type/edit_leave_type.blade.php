  ...
  <div class="row">
    <div class="col-md-5">
      ...
      <div class="box box-info">
        ...
        {!! Form::open(array('route' => array('leave_type.update', $leave_type->id), 'id' => 'add_holiday_form', 'method'=>'PUT')) !!}            
        ...
        <div class="box-body">
          <div class="col-md-12"> 
            <div class="form-group @if ($errors->has('leave_type_name')) has-error @endif">
              ...
              <input type="text" class="form-control" id="leave_type_name" name="leave_type_name" placeholder="Enter name" value="{{$leave_type->leave_type_name}}"> 
          ...
          <div class="col-md-12"> 
            <div class="form-group @if ($errors->has('payment_type')) has-error @endif">
              ...
              <div class="checkbox">
                @if($leave_type->payment_type==1)
                <label><input type="checkbox" class="minimal" name="payment_type" id="payment_type" value="1" checked="">With Pay</label>
                @else
          ...
          <div class="col-md-12"> 
            <div class="form-group @if ($errors->has('carry_forward')) has-error @endif">
              ...
              <div class="checkbox">
                @if($leave_type->carry_forward==1)
                <label><input type="checkbox" class="minimal" name="carry_forward" id="carry_forward" value="1" checked="">Merge Unused Leave with next year</label>
                @else
