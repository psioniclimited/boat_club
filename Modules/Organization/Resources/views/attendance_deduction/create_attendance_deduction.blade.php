...
<section class="content">
  <div class="row">
    ...
    <div class="col-md-12"> 
      {!! Form::open(array('route'=>'attendance_deduction.store','id'=>'attendance_deduction_form','class' => 'form-horizontal')) !!}
        ...
        <div class="box-body">
          <div class="col-md-12"> 
            <div class="form-group @if ($errors->has('deduction_policy_name')) has-error @endif">
              ...
              <input type="text" class="form-control" id="deduction_policy_name" name="deduction_policy_name" placeholder="Enter name" value="{{old('deduction_policy_name')}}" > 
            ...
            <div class="bootstrap-timepicker">
             <div class="form-group @if ($errors->has('late_entry_time')) has-error @endif">
              ...
              <div class="input-group"> 
                <input type="text" class="form-control" id="late_entry_time" name="late_entry_time" placeholder="Enter Time" value="{{old('late_entry_time')}}" > 
        ...
        <div class="col-md-6"> 
          <div class="bootstrap-timepicker">
            <div class="form-group @if ($errors->has('early_out_time')) has-error @endif">
              ...
              <div class="input-group"> 
               <input type="text" class="form-control" id="early_out_time" name="early_out_time" placeholder="Enter Time" value="{{old('early_out_time')}}" > 
               <div class="input-group-addon">
                <i class="fa fa-clock-o"></i>
              </div>
            </div><!-- /.input group -->
    ...
    <div class="box-body">
      <div class="col-md-5"> 
        <div class="form-group @if ($errors->has('late_entry_day_count')) has-error @endif">
          ...
          <input type="number" class="form-control" id="late_entry_day_count" name="late_entry_day_count" placeholder="The number of days entering late" value="{{old('late_entry_day_count')}}" > 
      ...
      <div class="col-md-5"> 
        <div class="form-group @if ($errors->has('late_entry_deduction_day')) has-error @endif">
          ...
          <input type="number" class="form-control" id="late_entry_deduction_day" name="late_entry_deduction_day" placeholder="Number of days to be deducted" value="{{old('late_entry_deduction_day')}}" > 
    ...
    <div class="box-body">
      ...
      <div class="col-md-5"> 
        <div class="form-group @if ($errors->has('early_out_day_count')) has-error @endif">
          ...
          <input type="number" class="form-control" id="early_out_day_count" name="early_out_day_count" placeholder="The number of days leaving early" value="{{old('early_out_day_count')}}" > 
      ...
      <div class="col-md-5"> 
        <div class="form-group @if ($errors->has('early_out_deduction_day')) has-error @endif">
          ...
          <input type="number" class="form-control" id="early_out_deduction_day" name="early_out_deduction_day" placeholder="Number of days to be deducted" value="{{old('early_out_deduction_day')}}" > 
