                ...
                <div class="box-body">
                    <div class="col-md-12"> 
                        <div class="form-group @if ($errors->has('salary_head_name')) has-error @endif">
                            ...
                            <input type="text" class="form-control" id="salary_head_name" name="salary_head_name" placeholder="Enter name" value="{{$salary_head->salary_head_name}}"> 
                        ...
                        <div class="form-group @if ($errors->has('acc_code')) has-error @endif">
                            ...
                            <input type="text" class="form-control" id="acc_code" name="acc_code" placeholder="Enter Address" value="{{$salary_head->acc_code}}"> 
                        ...
                        <div class="form-group @if ($errors->has('salary_head_type_id')) has-error @endif">
                            ...
                            <select class="js-example-basic-single js-states form-control" name="salary_head_type_id" id="salary_head_type_id"> 
                                ...
                                @if($type->id == $salary_head->salary_head_type_id)
