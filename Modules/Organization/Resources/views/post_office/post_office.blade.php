    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="box box-info">
                ...
                {!! Form::open(array('route'=>'post_office.store','id'=>'add_post_office_form','class' => 'form-horizontal')) !!}
                <div class="box-body">
                    <div class="col-md-12"> 
                        <div class="form-group @if ($errors->has('post_office_name')) has-error @endif">
                            ...
                            <input type="text" class="form-control" id="post_office_name" name="post_office_name" placeholder="Enter name" value="{{old('name')}}"> 
