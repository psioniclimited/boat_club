    ...
    <div class="col-md-6"> 
      <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title">Weekly Holiday Create</h3>
        </div>

        {!! Form::open(array('route'=>'week_holiday.store','id'=>'add_week_holiday_form','class' => 'form-horizontal')) !!}
        ...
        <div class="box-body">
          <div class="col-md-12"> 
            ...
            <div class="form-group @if ($errors->has('week_holiday_master_name')) has-error @endif">
              ...
              <input type="text" class="form-control" id="week_holiday_master_name" name="week_holiday_master_name" placeholder="Enter name" value="{{old('week_holiday_master_name')}}" > 
            ...
            <div class="form-group ">
              ...
              <div class="checkbox">
                <label><input type="checkbox" class="minimal" name="checked_days[]" id="checked_days[]" value="{{$day->id}}">{{$day->dayname}}</label>
              </div>
              @endforeach                          
            </div>
