    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="box box-info">
                ...
                {!! Form::open(array('route' => array('role.update', $role->id), 'id' => 'edit_role_form', 'method'=>'PUT')) !!}
                <div class="box-body">
                    @if (count($errors) > 0)
                    ...
                    <div class="col-md-12"> 
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="display_name" name="display_name" placeholder="Enter Display Name" value="{{$role->display_name}}"> 
                        </div>
                        <div class="form-group">
                            <label for="description" class="control-label">Description</label> 
                            <input type="text" class="form-control" id="description" name="description" placeholder="Enter Description" value="{{$role->description}}"> 
                        </div>
                    </div>
                    <!-- /.col -->
                </div>
