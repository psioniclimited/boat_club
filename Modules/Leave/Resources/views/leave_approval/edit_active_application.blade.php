  ...
  <div class="row">
    ...
    <div class="col-md-12"> 
      <div class="box box-info">
        ...
        {!! Form::open(array('route' => array('leave_approval.update', $leave_application->id), 'id' => 'leave_application_form', 'method'=>'PUT')) !!}         
        <div class="box-body">
          ...
          <div class="col-md-6">  
            <div class="form-group @if ($errors->has('leave_type_id')) has-error @endif">
              ...
              <select class="form-control" id="leave_type_id" name="leave_type_id" disabled=""> 
              </select>   
          ...
          <div class="col-md-6">  
            ...
            <div class="form-group @if ($errors->has('employees_master_id')) has-error @endif">
              ...
              <select class="form-control" id="employees_master_id" name="employees_master_id" disabled="" > 
              </select>                 
          ...
          <div class="col-md-6">  
            <div class="form-group @if ($errors->has('from_date')) has-error @endif">
              ...
              <input type="text" class="form-control" id="from_date"  placeholder="Select Start Date" value="{{$leave_application->from_date}}"  data-date-format='yyyy-mm-dd' readonly=""> 
          ...
          <div class="col-md-6">  
            <div class="form-group @if ($errors->has('to_date')) has-error @endif">
              ...
              <input type="text" class="form-control" id="to_date" placeholder="Select End Date" value="{{$leave_application->to_date}}"  data-date-format='yyyy-mm-dd' readonly=""> 
              @if ($errors->has('from_date')) <p class="help-block">{{ $errors->first('from_date') }}</p> @endif                             
            </div>   
          </div><!-- /.col-md-6 -->
          ...
          <div class="col-md-12">  
            <div class="form-group @if ($errors->has('reason')) has-error @endif">
              ...
              <div class="box-body pad"> 
                <textarea  class="textarea" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" readonly>{{$leave_application->reason}}</textarea>
              </div>
      ...
      <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title">Decision Panel</h3>
        </div>

        <div class="box-body">

          <div class="col-md-6">   
          <label for="name" class="control-label">Total Working Days</label>
           <input type="text" class="form-control"  value="{{$leave_application->working_days}}"  data-date-format='yyyy-mm-dd' readonly="">  
         </div> 
         <div class="col-md-6">   
           <label for="name" class="control-label">Remaining Leave Balance</label>
           <input type="text" class="form-control"  value="{{$remaining_balance}}"  data-date-format='yyyy-mm-dd' readonly="">  
         </div>   
        ...
        <div class="col-md-12">  
          <div class="form-group @if ($errors->has('remarks')) has-error @endif">
            ...
            <div class="box-body pad"> 
              <textarea  class="textarea" placeholder="Place some text here" name="remarks" style="width: 100%; height: 100px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" ></textarea>
            </div>
  ...
  $(document).ready(function () {
    ...
    $('#leave_application_form').validate({
      ...
      rules: {
        ...
        leave_status_id: {required: true},
        
      },
      messages: {  
        leave_status_id: {required: "Please Select Leave Status"},
      }
    });
