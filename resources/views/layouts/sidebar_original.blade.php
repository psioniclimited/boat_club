    ...
    <!--     <div class="user-panel">
        ...
        <li class="treeview" {!! Request::is('/district') || Request::is('/post_office') ? ' class="treeview active"' : ' class="treeview"' !!}>
          ...
          <ul class="treeview-menu"> 
           <li {!! Request::is('/district') ? ' class="active"' : null !!}><a href="{{URL::to('/district')}}">District</a></li>
           <li {!! Request::is('/post_office') ? ' class="active"' : null !!}><a href="{{URL::to('/post_office')}}">Post Office</a></li>
